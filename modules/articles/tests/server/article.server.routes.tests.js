        ...
        .end(function (signinErr, signinRes) {
          ...
          agent.post('/api/articles')
            ...
            .end(function (articleSaveErr, articleSaveRes) {
              ...
              should.exist(articleSaveRes.body.createdBy);
              should.equal(articleSaveRes.body.createdBy._id, orphanId);
        ...
        .end(function (signinErr, signinRes) {
          ...
          agent.post('/api/articles')
            ...
            .end(function (articleSaveErr, articleSaveRes) {
              ...
              (articleSaveRes.body.title).should.equal(article.title);
              should.exist(articleSaveRes.body.createdBy);
              should.equal(articleSaveRes.body.createdBy._id, userId);
